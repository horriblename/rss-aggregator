...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-xza3leu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-xza3leu.containers.anotherwebservice.com/
...
```
git clone git@github.com:horriblename/rss-aggregator.git
cd container-xza3leu
```
...
```
docker attach container-xza3leu
```
